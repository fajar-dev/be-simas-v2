...
import { AssetHandover } from "../src/modules/asset-handover/entities/asset-handover.entity"
import { AssetHandoverItem } from "../src/modules/asset-handover/entities/asset-handover-item.entity"
...
const TestDataSource = new DataSource({
    ...
    synchronize: true,
    dropSchema: true,
    entities: [User, Role, Permission, Category, SubCategory, Employee, Branch, Location, Asset, AssetLabel, Attachment, AssetMaintenance, AssetNote, AssetLocation, AssetHolder, AssetLog, AssetStatus, AssetHandover, AssetHandoverItem, PasswordResetToken],
    logging: false,
})
