...
export interface ISubCategoryRepository {
    findAll(page: number, limit: number, q: string, categoryId?: number, sortBy?: string, order?: 'ASC' | 'DESC'): Promise<{ data: SubCategory[]; total: number }>
    ...
    countAssets(subCategoryId: number): Promise<number>
}
