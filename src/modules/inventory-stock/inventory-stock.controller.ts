...
export class InventoryStockController {
    ...
    async stockOuts(c: Context) {
        ...
        return ApiResponse.paginate(c, InventoryStockSerializer.stockOuts(data), total, page, limit)
    }
    ...
    async assign(c: Context) {
        ...
        return ApiResponse.success(c, InventoryStockSerializer.stockOuts(stockOuts), "Stock assigned successfully", 201)
    }
