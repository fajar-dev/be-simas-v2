...
const PERMISSIONS = [
    ...
    { module: 'asset-schedule', action: 'read' },
    { module: 'asset-schedule', action: 'create' },
    { module: 'asset-schedule', action: 'update' },
    { module: 'asset-schedule', action: 'delete' },
    ...
    { module: 'inventory-variant', action: 'delete' },
    { module: 'inventory-stock', action: 'read' },
    { module: 'inventory-stock', action: 'entry' },
